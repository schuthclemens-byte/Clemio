  ...
  return (
    <div className="bg-card rounded-2xl shadow-sm overflow-hidden p-4 space-y-3">
      ...
      <div className="flex gap-2 pt-1">
        ...
        <button
          onClick={async () => { setTestLoading(true); await sendTestPush(); setTestLoading(false); }}
