...
const getInitialCountry = (): Country => {
  const saved = localStorage.getItem("clemix_last_phone") || "";
...
const LoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    localStorage.setItem("clemix_last_phone", cleanPhone);
        ...
        <div className="w-full max-w-sm animate-reveal-up">
          ...
          <div className="text-center mb-10">
            <div className="relative w-20 h-20 mx-auto mb-5">
              <img src="/icon-512.png" alt="Clemix" className="w-20 h-20 rounded-3xl shadow-soft" />
            </div>
