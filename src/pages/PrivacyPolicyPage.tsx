          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="divide-y divide-border/50">
                ...
                <tr><td className="py-2 pr-3">Apple / Google (In-App-Kauf)</td><td className="py-2 pr-3">USA / Irland</td><td className="py-2">EU-US Data Privacy Framework / EU</td></tr>
                <tr><td className="py-2 pr-3">RunPod (Speech-to-Text)</td><td className="py-2 pr-3">USA</td><td className="py-2">{t("privacy.s17ConsentScc")}</td></tr>
