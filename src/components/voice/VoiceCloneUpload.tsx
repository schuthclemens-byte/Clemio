...
const VERIFICATION_SENTENCES: Record<string, string[]> = {
  de: [
    ...
    "Jeden Morgen trinke ich eine Tasse Kaffee und lese dabei die Nachrichten.",
    "Die Berge im Herbst sind besonders schön, wenn sich die Blätter bunt färben.",
    "Gestern habe ich einen alten Freund getroffen und wir haben stundenlang geredet.",
    "Das Konzert gestern Abend war fantastisch und die Musik hat mich tief berührt.",
    "Ich plane eine Reise nach Italien und freue mich schon auf das leckere Essen.",
    "Nach dem Regen erscheint oft ein wunderschöner Regenbogen am Himmel über der Stadt.",
    "Meine Katze schläft am liebsten auf der warmen Fensterbank in der Nachmittagssonne.",
    "Am liebsten koche ich abends etwas Neues und probiere Rezepte aus aller Welt.",
    "Der Markt am Samstag hat frisches Obst und Gemüse direkt von den Bauern.",
    "Wenn es schneit, bauen die Kinder im Garten einen großen Schneemann mit Karottennase.",
  ],
  en: [
    ...
    "Every morning I drink a cup of coffee and read the news while doing so.",
    "The mountains in autumn are especially beautiful when the leaves change color.",
    "Yesterday I met an old friend and we talked for hours about everything.",
    "The concert last night was fantastic and the music touched me deeply.",
    "I am planning a trip to Italy and I am already looking forward to the delicious food.",
    "After the rain a beautiful rainbow often appears in the sky above the city.",
    "My cat loves to sleep on the warm windowsill in the afternoon sunshine.",
    "In the evening I love to cook something new and try recipes from around the world.",
    "The market on Saturday has fresh fruit and vegetables straight from the farmers.",
    "When it snows the children build a big snowman with a carrot nose in the garden.",
  ],
};
